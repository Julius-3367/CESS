          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link 
              ...
              className={`text-sm transition-colors ${
                pathname === '/' ? 'text-brand-red font-medium' : 'text-brand-slate hover:text-brand-red'
              }`}
            >
              Home
            </Link>
            ...
            <Link 
              href="/calculator" 
              className={`text-sm transition-colors ${
                pathname === '/calculator' ? 'text-brand-red font-medium' : 'text-brand-slate hover:text-brand-red'
              }`}
            >
              Calculator
            </Link>
